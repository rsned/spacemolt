...
> **This document is accurate for gameserver v0.104.1**
>
...
- `get_recipes()` -- Get all crafting recipes
- `get_ship()` -- Get detailed ship information
- `get_ships()` -- List all available ship classes for purchase
- `get_skills()` -- Get all skills and your progress

...
type GameClient interface {
	...
	Espionage(ctx context.Context) error
	...
	DeployDrone(ctx context.Context, droneID string, all bool) error
	SetDroneName(ctx context.Context, droneID, name string) error

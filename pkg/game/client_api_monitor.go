...
var actionResponseTypes = map[string]reflect.Type{
	...
	"stance":          reflect.TypeOf(serverapi.StanceResponse{}),
...
var eventExpectedFields = map[string]map[string]bool{
	...
	protocol.TypeShipCaptured: {
		"battle_id":             true,
		"tick":                  true,
		"boarding_operation_id": true,
		"captor_id":             true,
		"captor_username":       true,
		"former_owner_id":       true,
		"former_owner_username": true,
		"ship_id":               true,
		"ship_class":            true,
	},
	...
	protocol.TypePersonnelUpdate: {
		...
		"crew_treated":                true,
		"marines_treated":             true,
		"fit_crew_transferred":        true,
		"fit_marines_transferred":     true,
		"injured_crew_transferred":    true,
		"injured_marines_transferred": true,
		"injured_crew_swapped":        true,
		"injured_marines_swapped":     true,
		"crew_capacity":               true,
		"marine_capacity":             true,
		"personnel":                   true,
	},

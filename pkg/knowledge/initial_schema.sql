-- SpaceMolt Knowledge Base: baseline schema (migration 59, "baseline_2026_09_08").
--
-- AUTO-GENERATED on 2026-09-08 by dumping a fresh database after migration 60.
-- It replaces the 1..59 migration chain, which was collapsed (for the second
-- time; the first collapse folded 1..30 on 2026-04-15). Do NOT edit this file
-- by hand and do NOT edit a migration that has already run on the live
-- database: add a new numbered migration in sqlite_migrations.go instead.
-- Commit fff8e9cb edited migration 35 in place and the live database silently
-- diverged for four months; migration 60 is the reconciliation.
--
-- Databases whose ledger is below 59 are refused by runMigrations (see
-- collapseFloor); upgrade them with a build at or before commit d4350708.
--
-- Known cosmetic difference on the live database: pois.class carries
-- DEFAULT '' there and no default here. Every reader coalesces NULL and ''.
--
-- ============================================================================
-- TABLES
-- ============================================================================

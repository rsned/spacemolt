...
export const ChatPanel: React.FC<ChatPanelProps> = ({ chat, isConnected }) => {
  ...
  return (
    <div className="bg-spacemolt-panel border border-spacemolt-border rounded-lg p-4 min-w-0">
        ...
        <>
          ...
          <div className="flex gap-2 min-w-0">
            <input
              ...
              className="flex-1 min-w-0 bg-gray-800 border border-gray-700 rounded px-3 py-2 text-sm focus:outline-none focus:border-cyan-500"
            />
